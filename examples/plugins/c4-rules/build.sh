#!/bin/sh
# Rebuild the c4.rules component from guest/ and place it beside the
...
out="$here/../../packages/c4-tournament/c4-rules.wasm"
cd "$here/guest"
cargo build --release --target wasm32-unknown-unknown
wasm-tools component new \
  target/wasm32-unknown-unknown/release/c4_rules.wasm \
  -o "$out"
