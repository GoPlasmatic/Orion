...
Tested with Orion 1.10.0. You need Claude Code, a POSIX shell, the Orion agent skill source, and [Orion and the CLI installed](../../get-started/install.md). Start the server locally, then configure the CLI and install the skill:
