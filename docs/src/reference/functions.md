<!-- description: Every built-in Orion task function with its input schema: parse, map, filter, validation, HTTP and channel calls, SQL, MongoDB, cache, Kafka, email, JWT, ONNX. -->
# Function Reference
