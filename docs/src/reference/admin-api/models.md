...
It reads the graph: parameter and node counts, IR version and opset. Every manifest input and output must name a graph tensor, and `models.max_parameters` applies.
