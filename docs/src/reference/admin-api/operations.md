<!-- description: The admin endpoints that are not an entity: engine status and reload, the function catalogue, audit logs, the trace DLQ, cron occurrences and backups. -->
<!-- type: hub -->
