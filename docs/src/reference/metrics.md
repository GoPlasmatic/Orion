...
| `orion_jwt_rejections_total` | Counter | `reason` | JWTs refused at channel auth, by typed cause (`expired`, `bad_signature`, `alg_rejected`, `scheme_mismatch`, …) — the wire answer stays uniform; the dashboard does not have to. |
