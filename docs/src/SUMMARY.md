...
- [Understand the HTTP Flow](./getting-started/first-service.md)
...
- [Understand Channels](./concepts/channels.md)
...
- [How to Author Workflows](./build/workflows.md)
...
- [Orders API: End-to-End Golden Path](./guides/orders-golden-path.md)
...
- [Upgrades](./operate/upgrades.md)
  - [Upgrading to 1.8.0](./operate/upgrading-to-1.8.md)
...
- [Using the Reference](./reference/using-reference.md)
