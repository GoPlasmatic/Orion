...
const CACHE_WRITE_FIELDS: &[FieldSchema] = &[
    ...
    FieldSchema {
        name: "value_logic",
        description: "JSONLogic expression evaluated against the message to derive the value.",
        kind: FieldKind::Any,
        required: false,
    },
    FieldSchema {
...
const HTTP_CALL_FIELDS: &[FieldSchema] = &[
    ...
    FieldSchema {
        name: "path",
        description: "Path appended to the connector's base URL.",
        kind: FieldKind::String,
        required: false,
    },
    FieldSchema {
    ...
    FieldSchema {
        name: "body",
        description: "Request body (any JSON value).",
        kind: FieldKind::Any,
        required: false,
    },
    FieldSchema {
    ...
    FieldSchema {
        name: "output",
        description: "Dotted path where the response body is written.",
        kind: FieldKind::String,
        required: false,
    },
];
