...
validation failures.",
    ...
    tags(
        ...
        (name = "Plugins", description = "WebAssembly plugins: sandboxed custom task functions"),
        (name = "Models", description = "ONNX models held in object storage: registered by \
            reference, admitted by the node that fetches and verifies them"),
    ...
    paths(
        ...
        // Plugins
        super::admin::plugins::list_plugins,
        super::admin::plugins::create_plugin,
        super::admin::plugins::get_plugin,
        super::admin::plugins::update_plugin,
        super::admin::plugins::delete_plugin,
        super::admin::plugins::change_plugin_status,
        super::admin::plugins::list_plugin_versions,
        super::admin::plugins::create_new_plugin_version,
        super::admin::plugins::plugin_dependencies,
        super::admin::plugins::import_plugins,
        super::admin::plugins::export_plugins,
        super::admin::plugins::validate_plugin,
        // Models
        super::admin::models::list_models,
        super::admin::models::create_model,
        super::admin::models::get_model,
        super::admin::models::update_model,
        super::admin::models::delete_model,
        super::admin::models::change_model_status,
        super::admin::models::admit_model,
        super::admin::models::list_model_versions,
        super::admin::models::create_new_model_version,
        super::admin::models::model_dependencies,
        super::admin::models::import_models,
        super::admin::models::export_models,
        super::admin::models::validate_model,
        // Workflows
        ...
        // Trace DLQ
        super::admin::cron::list_occurrences,
        super::admin::cron::get_occurrence,
        super::admin::cron::retry_occurrence,
        super::admin::cron::cancel_occurrence,
        super::admin::cron::cron_status,
        super::admin::cron::trigger_channel,
    ...
    components(
        schemas(
            ...
            crate::storage::repositories::plugins::CreatePluginRequest,
            crate::storage::repositories::plugins::UpdatePluginRequest,
            crate::storage::models::PluginResponse,
            crate::storage::models::PluginHealth,
            super::admin::plugins::PluginDependencies,
            crate::storage::repositories::models::CreateModelRequest,
            crate::storage::repositories::models::UpdateModelRequest,
            crate::storage::models::ModelResponse,
            crate::storage::models::ModelArtifactRef,
            crate::storage::models::ModelAdmission,
            crate::storage::models::ModelStats,
            crate::storage::models::ModelHealth,
            super::admin::models::ModelDependencies,
            super::admin::services::models::ModelDependant,
            super::admin::models::ModelValidationEnvelope,
            super::admin::models::ModelValidationResponse,
            super::admin::models::ArtifactHead,
            ...
            crate::storage::models::CronOccurrenceResponse,
            crate::storage::models::CronOccurrenceSummaryResponse,
            crate::storage::models::CronScheduleStatusResponse,
